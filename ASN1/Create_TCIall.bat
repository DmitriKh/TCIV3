...
copy /Y TCIDispatcher.asn + separator.txt + TCI29451.asn + separator.txt + TCI31611.asn + separator.txt + TCI16093DSRC.asn + separator.txt + TCI16093PC5.asn + separator.txt + TCI16092.asn + separator.txt + TCI16094.asn + separator.txt + TCI80211.asn + separator.txt + TCISutControl.asn + separator.txt + TCIresponseInfo.asn + separator.txt + TCIindication.asn + separator.txt + TCIip.asn + separator.txt + TCIwsm.asn + separator.txt + TCIEventHandling.asn + separator.txt + TCICommonTypes.asn + separator.txt + "1609dot3\17419_CITSapplMgmtIDs_v1.asn" + separator.txt + "1609dot3\wee.asn" + separator.txt + "1609dot3\wsa.asn" + separator.txt + "1609dot3\EUTRA-RRC-Definitions.asn" + separator.txt + "1609dot3\EUTRA-Sidelink-Preconf.asn" /A TCIall.asn /B
